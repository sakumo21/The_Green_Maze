...
FILES =  mandatory_files/parsing/parsing1.c mandatory_files/parsing/parsing2.c mandatory_files/parsing/parsing3.c mandatory_files/parsing/parsing4.c mandatory_files/parsing/parsing5.c mandatory_files/parsing/map_parsing1.c mandatory_files/parsing/map_parsing2.c mandatory_files/parsing/map_parsing3.c mandatory_files/main.c mandatory_files/keys.c mandatory_files/calculations.c mandatory_files/coloring.c mandatory_files/put_pixel.c mandatory_files/cub3d_utils.c mandatory_files/texturing.c mandatory_files/texturing2.c mandatory_files/movement.c mandatory_files/cub3d_utils1.c
