...
{
	rendering_image(img, 0, "bonus_files/textures/puunch3.xpm");
	usleep(10000);
	rendering_image(img, 0, "bonus_files/textures/puunch3.xpm");
	usleep(40000);
	rendering_image(img, 0, "bonus_files/textures/puunch2.xpm");
	usleep(40000);
	rendering_image(img, 0, "bonus_files/textures/puunch.xpm");
}

void	pistol_frames(t_data *img)
{
	rendering_image(img, 0, "bonus_files/textures/pistool2.xpm");
	usleep(40000);
	rendering_image(img, 0, "bonus_files/textures/pistool3.xpm");
	usleep(40000);
	rendering_image(img, 0, "bonus_files/textures/pistool4.xpm");
	usleep(40000);
	rendering_image(img, 0, "bonus_files/textures/pistool5.xpm");
	usleep(40000);
	rendering_image(img, 0, "bonus_files/textures/pistool2.xpm");
	usleep(40000);
	rendering_image(img, 0, "bonus_files/textures/pistool.xpm");
}
